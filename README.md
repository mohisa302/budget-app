...
# 📖 Costino <a name="about-project"></a>

**Costino** is an application that One can create categories for all their transaction, view total cost of all categories, view the cost of one transaction.
...
The hosted app can be found [here](https://costino-app.onrender.com/)
...
- Clone the project to your directory by running
  - `git@github.com:mohisa302/budget-app.git`
- Run `Bundle install`
- Run `npm install`
...
- Create a local directory where you can clone the project
- Clone the project to your directory by running
  - `git clone git@github.com:mohisa302/budget-app.git`
